...
{
    public class SaidaInputValidator : AbstractValidator<SaidaInput>
    {
        ...
        public SaidaInputValidator()
        {
            ...
            RuleFor(x => x.IdTipoSaida)
                .NotNull().WithMessage("O Tipo de Saída é obrigatório").WithSeverity(Severity.Warning);
